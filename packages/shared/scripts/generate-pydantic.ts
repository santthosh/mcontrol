 ...
 *
 * This is a simple codegen script that outputs Python Pydantic models
 * matching our TypeScript Zod schemas. For a production system, consider
 * using a more robust solution like zod-to-json-schema + datamodel-code-generator.
 */
...
const outputPath = join(__dirname, "..", "python", "schemas.py");
writeFileSync(outputPath, pydanticCode);
console.log(\`Generated Pydantic models at: \${outputPath}\`);
